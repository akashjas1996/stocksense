...
<div class="card" style="text-align:center;padding:32px 20px;">
    <div style="font-size:2rem;margin-bottom:8px;"><?= containerIcon($container['type'] ?? 'other') ?></div>
    <div style="font-weight:800;font-size:1.1rem;margin-bottom:4px;"><?= e($container['name']) ?></div>
    <div style="font-size:.8rem;color:var(--text-3);margin-bottom:24px;">Print and stick this on the container</div>
